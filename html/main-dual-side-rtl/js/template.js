...
//Primary use:	WebkitX Admin - Responsive Admin Template
...
$('.scroll-nav').slimScroll({
  ...
  // Close
	...
	// bradcrumb section
        ...
        $("#chat-circle, #chat-box-toggle, #chat-popup, #chat-box-btn").click(function(){
...
$(document).ready(function() {   
	 function setHeight() {
		 ...
		 $('.aside-workspace, .content-wrapper').css({
